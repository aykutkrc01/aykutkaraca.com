...
const WHATSAPP_URL =
  'https://wa.me/905419383012?text=Merhaba%20Aykut%20Bey%2C%20web%20siteniz%20%C3%BCzerinden%20ula%C5%9F%C4%B1yorum.';
...
function TomorrowHR({ className = '' }: { className?: string }) {
  return (
    <span className={`font-sans tracking-[-0.015em] ${className}`}>
      <span className="font-[350]">tomorrow</span>
      <b className="font-[750] text-[var(--color-teal-deep)]">HR</b>
    </span>
  );
}
    ...
    <section className="grid items-center gap-[var(--space-lg)] py-[var(--space-xl)] md:min-h-[640px] md:grid-cols-[minmax(360px,44%)_1fr] md:gap-[var(--space-xl)] md:py-[var(--space-2xl)]">
      <div className="max-w-[480px]">
        ...
        <p className="mt-[var(--space-lg)] max-w-[42ch] font-sans text-[17.5px] leading-[1.6] text-[var(--color-warm-gray)]">
          ...
          aynı know-how, <TomorrowHR className="text-[var(--color-charcoal)]" /> ile
          AI destekli ürüne dönüşür.
        </p>
        ...
        <div className="mt-[var(--space-2xl)] flex max-w-[420px] flex-col gap-[10px]">
          ...
          >
            <span className="flex h-[38px] w-[38px] flex-none items-center justify-center rounded-[10px] bg-[rgba(31,168,85,0.1)] text-[var(--color-wa)]">
              <WhatsAppIcon />
            </span>
            <span className="min-w-0 flex-1">
              ...
              <span className="block font-sans text-[13px] text-[var(--color-warm-gray)]">
                AI ürün fikri ya da proje — direkt konuşalım
              </span>
            </span>
          ...
          <a
            ...
            className="lift-link flex items-center gap-[14px] rounded-[12px] border border-[var(--color-border)] bg-white px-[18px] py-[14px] shadow-[var(--shadow-soft)]"
          >
            <span className="flex h-[38px] w-[38px] flex-none items-center justify-center rounded-[10px] bg-[linear-gradient(135deg,var(--color-teal),var(--color-teal-deep))] font-sans text-[13px] font-extrabold tracking-[0.02em] text-white">
              HR
            </span>
            <span className="min-w-0 flex-1">
              <span className="block font-sans text-[15px] font-semibold tracking-[-0.01em]">
          ...
          <a
            ...
            className="lift-link flex items-center gap-[14px] rounded-[12px] border border-[var(--color-border)] bg-white px-[18px] py-[14px] shadow-[var(--shadow-soft)]"
          >
            <span className="flex h-[38px] w-[38px] flex-none items-center justify-center rounded-[10px] bg-[rgba(10,102,194,0.08)] text-[#0A66C2]">
